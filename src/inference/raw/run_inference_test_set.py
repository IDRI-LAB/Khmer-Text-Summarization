...
MODELS_TO_RUN = [
    {
        ...
        "output": "outputs/raw_fine_tune_prediction_llama.jsonl"
    },
    {
        "name": "qwen",
        "model_name": "./outputs_Qwen2.5-7B-Instruct-bnb-4bit/checkpoint-215",
        "output": "outputs/raw_fine_tune_prediction_qwen.jsonl"
    },
    {
        "name": "gemma",
        "model_name": "./outputs_gemma-2b-bnb-4bit/checkpoint-86",
        "output": "outputs/raw_fine_tune_prediction_gemma.jsonl"
    }
]

DATASET_PATH = "../../data/raw/test_20percent_cleaned.jsonl"
